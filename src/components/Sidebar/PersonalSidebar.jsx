...
function PersonalSidebar() {
    ...
    const navItems = [
        ...
        { path: '/app/add', label: 'Add Transaction', icon: 'add' },
        { path: '/app/recurring', label: 'Recurring', icon: 'recurring' },
        { path: '/app/wallets', label: 'Wallets', icon: 'wallet' },
        { path: '/app/reports', label: 'Reports', icon: 'chart' },
    ...
    return (
        <aside className="sidebar">
            <div className="sidebar__logo">
                <Logo size={40} />
                <span className="sidebar__logo-text">My Wallet</span>
            </div>
